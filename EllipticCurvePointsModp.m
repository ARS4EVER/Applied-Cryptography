...
% Input: Two integers a, b, and a prime p > 3. It is assumed that 4a^3 + 27b^2 is nonzero, so that the associated elliptic curve
% y^2 = x^3 + ax + b
% is nonsingular.
...
% then do a brute force search for any y’s that satisfy the equation.
