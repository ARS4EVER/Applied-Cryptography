...
% C = DES(P, Key)
% Inputs: P = 64 bit (plaintext) vector P, Key = a 64 bit vector that serves as an admissible DES key.
% Output: C = the 64 bit (ciphertext) vector that corresponds to the output
